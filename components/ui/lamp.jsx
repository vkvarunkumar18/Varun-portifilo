...
import { motion } from "framer-motion"; // Changed from "motion/react" to "framer-motion" for standard import
  ...
  return (
    <div
      className={cn(
        ...
        className // Keep this to allow external classes, like !bg-transparent from Works component
      )}>
      {/* Changed bg-slate-950 to bg-transparent here */}
      <div
        ...
        <motion.div
          ...
          {/* Changed bg-slate-950 to bg-transparent or your desired background for these masks */}
          <div
        ...
        {/* Changed bg-slate-950 to bg-transparent or your desired background for these blur layers */}
        <div
        ...
        {/* Changed bg-slate-950 to bg-transparent for this bottom mask */}
        <div
